using TriliumAgent.Lib;
using TriliumAgent.Models;
using TriliumAgent.Services.Interfaces;
...
namespace TriliumAgent.Services.FileImplementation
{
    ...
    //        studies = ApplyStudyUidFilter(studies, query.FindQueryAttribute(0x0020, 0x000E)); //Ashish
