...
namespace TrilliumReportService.Helper
{
    public class ORUMessageModel
    {
       ...
       OBR-44 Procedure Code,OBR-45 Procedure Code Modifier*/
        ...
        {
            /*  OBX-1 Set ID - OBX,OBX-2 Value Type,OBX-3 Observation Identifier,OBX-4 Observation Sub-ID,OBX-5 Observation Value,  OBX-6 Units,
      OBX-7 References Range,  OBX-8 Abnormal Flags,  OBX-9 Probability,  OBX-10 Nature of Abnormal Test,  OBX-11 Observation Result Status,  OBX-12 Effective Date of Reference Range Values,
            OBX-13 User Defined Access Checks,  OBX-14 Date/Time of the Observation,  OBX-15 Producer's Reference,  OBX-16 Responsible Observer,  OBX-17 Observation Method,
            OBX-18 Equipment Instance Identifier,  OBX-19 Date/Time of the Analysis,  OBX-20 Performing Organization Name,  OBX-21 Performing Organization Address,  OBX-22 Performing Organization Medical Director */
